            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="add-subscription" method="post" action="{{route('add-subscription')}}">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('android_sku_code') is-invalid @enderror" name="android_sku_code" id="android_sku_code" value="{{ old('android_sku_code') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('ios_sku_code') is-invalid @enderror" name="ios_sku_code" id="ios_sku_code" value="{{ old('ios_sku_code') }}">
                                @error('ios_sku_code')
                                    <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea id="description"  name="description" class="form-control text-black rounded-10  @error('description') is-invalid @enderror"  style="height: 100px"> {{ old('description') }}</textarea>       
                                @error('description')
                                    <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
