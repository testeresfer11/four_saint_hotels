...
<div class="page-header">
    <h3 class="page-title">Edit Push Notification</h3>
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.pushnotification.edit', $pushNotification->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" class="form-control" rows="4">{{ old('body', $pushNotification->body) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        @if($pushNotification->image)
                            <img src="{{ $pushNotification->image }}" alt="Notification Image" width="100" class="mb-2">
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="type" class="form-control" value="{{ old('type', $pushNotification->type) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="notification_type" class="form-control" value="{{ old('notification_type', $pushNotification->notification_type) }}">
                 ...
                 {{-- Send To --}}
                    <div class="form-group">
                        ...
                        <select name="send_to" id="send_to" class="form-control">
                            ...
                            <option value="single" {{ $pushNotification->receiver_id && $pushNotification->receiver_id != 0 ? 'selected' : '' }}>Single User</option>
                            <option value="multiple" {{ is_array($selectedReceivers) && count($selectedReceivers) > 1 ? 'selected' : '' }}>Multiple Users</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group" id="single_user_div" style="display:none;">
                        ...
                        <select name="receiver_id" class="form-control">
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ $pushNotification->receiver_id == $user->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group" id="multiple_users_div" style="display:none;">
                        ...
                        <select name="receiver_ids[]" class="form-control" multiple>
                            @foreach($users as $user)
                                <option value="{{ $user->id }}" {{ in_array($user->id, $selectedReceivers ?? []) ? 'selected' : '' }}>
                                    {{ $user->full_name }} ({{ $user->email }})
                                </option>
                            @endforeach
                        </select>
