            ...
            <div class="card-body">
                ...
                <form id="edit-category" class="forms-sample" action="{{ route('admin.other_services.edit', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="hotel_room_id">Select Hotel Rooms</label>
                        <select class="form-control @error('hotel_room_id') is-invalid @enderror" name="hotel_room_id" id="hotel_room_id">

                            <option value="">Select Hotel Rooms</option>
                            @foreach($hotel_rooms as $hotel)
                            {{ $hotel->room_name }}
                                <option value="{{ $hotel->room_id }}" >
                                    {{ $hotel->room_name }}
                                </option>
                            @endforeach
                        </select>
