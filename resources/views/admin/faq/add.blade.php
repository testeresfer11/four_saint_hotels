                        ...
                        <form id="add-faq" method="post" action="{{route('add-faq')}}">
                            @csrf
                             ...
                             <div class="form-group">
                                ...
                                <textarea id="question"  name="question" class="form-control text-black rounded-10  @error('question') is-invalid @enderror"  style="height: 100px"> {{ old('question') }}</textarea>       
                                @error('question')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="answer"  name="answer" class="form-control text-black rounded-10  @error('answer') is-invalid @enderror"  style="height: 100px"> {{ old('answer') }}</textarea>       
                                @error('answer')
                                    <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
